...
print("\n*********************** Numericals To Words ***************************\n\n")
n = int(input(
    "Enter a Number you want to convert to Words : Minimum =0 Maximum = 9900009999999.\n\n This Program can help you within this limit only : "))  # Take input in numerical

highers = ["Lakh Crores", "Lakh Crore", "Hundred Crores", "Hundred Crore", "Crores", "Crore", "Lakhs", "Lakh",
           "Thousands", "Thousand", "Hundred", "Hundred and"]
