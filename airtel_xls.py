...
pdfFileObj = open('/storage/emulated/0/Download/DE15117561.pdf', 'rb')
...
ex_data.to_excel('/storage/emulated/0/Download/gst_file_May.xlsx', index=False, sheet_name=month_year)
print(ex_data)
